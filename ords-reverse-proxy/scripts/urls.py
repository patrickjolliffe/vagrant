...
cache_parser.add_argument('--no_cache', action='store_false')
    ...
    for method in methods:
        for protocol in protocols:
            for proxy in proxies:
                setup(protocol,proxy,method,cache,args.port, args.auto, args.verbose)
                #run_siege()